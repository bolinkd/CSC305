...
u8vec4 to_bgra(glm::u8vec4 rgba)
{
    ...
    int fbwidth, int fbheight, u8vec4* framebuffer, float* depthbuffer)
{
    ...
    // translated cube
    {
        ...
        mat4 translation = translate(vec3(0,4.0f*sin(curr_time),0));
    ...
    // scaled cube
    {
        ...
        mat4 translation = translate(vec3(3,3,3));

        mat4 scaling = scale(vec3(abs(sin(curr_time)),abs(sin(curr_time)),abs(sin(curr_time))));

        model = translation * scaling * model;
